import { CodeBlock, Reveal } from "@beckon/ui"
    ...
    <Reveal>
      <article className="space-y-10">
        <header className="space-y-3">
          <h1 className="text-3xl font-semibold text-ink">Getting started</h1>
        ...
        <section className="space-y-3">
          ...
          <ol className="list-decimal space-y-2 pl-5 text-ink-muted marker:text-ink-faint">
